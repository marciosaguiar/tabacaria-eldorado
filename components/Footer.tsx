...
export default async function Footer() {
  ...
  return (
    <footer
      style={{
        borderTop: '0.5px solid var(--el-gold-border)',
      ...
      >
        ...
        <div
          style={{
            height: '0.5px',
            marginBottom: '16px',
            background: 'linear-gradient(90deg, transparent, var(--el-gold-border), transparent)',
          }}
        />
        ...
        >
          ...
          >
            © {new Date().getFullYear()} {settings.nome}. Todos os direitos reservados.
          </p>
          <a
            href="/admin/login"
            style={{
