...
export default async function Footer() {
  ...
  const phrase     = settings.footerPhrase || settings.slogan
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="text-center mb-7">
          ...
          {phrase && (
            <p
              className="font-playfair text-sm italic max-w-md mx-auto leading-relaxed"
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-2">
              {settings.whatsapp && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-inter text-xs flex items-center gap-1.5 hover:underline transition-colors"
              ...
              {settings.telefone && !settings.whatsapp && (
                <a
                  ...
                  className="font-inter text-xs hover:underline transition-colors"
                  style={{ color: 'var(--text-secondary)' }}
                >
                  📞 {settings.telefone}
                </a>
