...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Catálogo Varejo — Tabacaria Eldorado',
    description: 'Produtos premium para o consumidor final.',
  },
}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-14 sm:py-20 text-center">
          ...
          <h1 className="font-playfair text-3xl sm:text-4xl md:text-5xl text-white mb-4 leading-tight">
            ...
            <span
              ...
              style={{ textShadow: '0 0 30px rgba(240,208,128,0.25)' }}
            >
              Varejo
            </span>
          </h1>
          ...
          <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-4 md:gap-5">
              {products.map((product) => (
                <ProductCard key={product.id} product={product} channel="varejo" />
              ))}
            </div>
          </>
        )}
