    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--text)' }}>
      ...
      <nav className="lg-nav" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <div style={{ position: 'relative', width: '28px', height: '28px' }}>
            <Image src={settings.logoUrl || '/images/logo.png'} alt={settings.nome}
              fill sizes="28px" style={{ objectFit: 'contain' }} priority />
          </div>
          <span style={{
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', width: '72px', height: '72px', marginBottom: '16px' }}>
          <Image src={settings.logoUrl || '/images/logo.png'} alt={settings.nome}
            fill sizes="72px"
            style={{ objectFit: 'contain', filter: 'drop-shadow(0 2px 12px rgba(200,137,26,0.35))' }}
            priority />
        </div>
        ...
        <h1 style={{
          ...
          lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: '6px',
        }}>
        ...
        {settings.slogan && (
          <p style={{
            ...
            lineHeight: 1.5, maxWidth: '260px', marginBottom: '32px',
          }}>
            {settings.slogan}
          </p>
        )}
        {!settings.slogan && <div style={{ marginBottom: '28px' }} />}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', width: '100%', maxWidth: '320px' }}>
          ...
          <Link href="/varejo" style={{ textDecoration: 'none' }}>
            <div style={{
              ...
              borderRadius: '12px',
              boxShadow: '0 4px 16px rgba(200,137,26,0.30)',
            ...
            >
              <div style={{ textAlign: 'left' }}>
                <div style={{
                  ...
                  color: 'rgba(255,255,255,0.75)', marginBottom: '2px',
                }}>
                  Para o consumidor
                </div>
                <div style={{
      ...
      {/* ── DIVISOR ──────────────────────────────────────────────── */}
      <div className="el-divider" style={{ margin: '0 24px' }} />
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
          ...
          {/* Copyright + Admin */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <p style={{ fontSize: '11px', color: 'var(--text-4)', fontFamily: 'var(--font-inter, sans-serif)' }}>
